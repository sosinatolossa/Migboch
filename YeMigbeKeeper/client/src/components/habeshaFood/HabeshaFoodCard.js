...
const HabeshaFood = ({ habeshaFood }) => {
    ...
    const editButton = () => {
        if (habeshaFood.user.id === currentUser?.id) {
            ...
            }} className="edit-button" variant="danger" style={{ margin: "5px" }}>
    ...
    const deleteButton = () => {
        if (habeshaFood.user.id === currentUser?.id) {
            ...
            }} className="delete-button" variant="danger" style={{ margin: "5px" }}>
            ...
            <Card >
                <Card.Body>
                    ...
                    <h1 className="foodName">
                        <Link style={{ color: "#ff7b00" }} to={`/HabeshaFood/${habeshaFood.id}`}>{habeshaFood.name}</Link>
                    </h1>
